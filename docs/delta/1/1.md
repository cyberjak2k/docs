...
!!! info "info"
    Screws need to be coated with threadlocker(Voron recommend Blue thread locke):
...
2. Insert the cap head screws into the metal corner brackets as shown in the picture.
   ![image.webp](11.webp){.img1}

3. Lightly tighten the Type 30-M4 drop-in t-nut, but do not tighten it completely.
...
5. Secure another metal corner bracket to the other end using the same installation method. Note the position of the metal corner brackets; the distance between the two metal corner brackets should be <strong>750MM</strong>.
...
1. When assembling the crossbeam, to ensure the short profiles are parallel, it is recommended to assemble on a flat table or hard flat surface.
   ![image.webp](jy.webp){.img1}
...
1. Place the stepper motor as shown, and cover it with a shock absorbing pad, as shown in the figure. 
   ![image.webp](27.webp){.img1}

2.Pass the four M3*10 cap-head screws through the metal corner bracket and the shock-absorbing pad to secure them to the stepper motor body, as shown in the figure.
...
???- faq "FAQ"
    ...
    **Q: Why are gaskets( special washers ) positive and negative?**

    **A:** The use of disc spring plus double-sided tooth anti-slip washer is mainly for the application scenario of metal to metal locking, vibration, heat, and loosening, there are tooth patterns on both the upper and lower sides once tightened, the teeth will be slightly embedded in the metal, any vibration can not cause the screw to loosen,  plus the washer is a tapered disc spring structure, there is a preload force, in the parts are heated and expanded, cooling and contracted, the contact surface is slightly crushed, wear, long-term vibration leads to the gap, and can continue to maintain the pressing force. After locking in place, they almost never loosen.  Please pay special attention to the installation direction of the special washer when installing, as incorrect installation will lead to incorrect elasticity, small preload and instability. When the screw is loosened and needs to be reinstalled, it is recommended to replace the gasket ( special washer ).


    **Q: Why do screws need to be threaded?**

    **A:** The purpose of gluing is to rely on chemical curing, "stick" to the thread, there is a lubricating effect when tightening, the torque is more stable, it does not bite to death at high temperature, fills the thread gap, is moisture-proof, anti-oxidation, anti-rust, has slight elasticity, can keep the locking force not attenuated. It is recommended to use Loctite's 243 thread adhesive, medium strength 7N, so that it can be disassembled later if needed.


    **Q: Can I use other glue?**

    **A:** If you don't consider disassembly, you can use Loctite's 270 or 271 high-strength red glue, if you forget to use thread locking adhesive when screwing in the screws, and don't want to have to disassemble, you can use penetrating green glue for reinforcement.


    **Q: Why choose boat type nuts?**

    **A:** There are many ways to secure. The reason for not choosing punching or tapping method, is mainly considering cost and scalability, the cost of punching is high and the cutting accuracy is not easy to guarantee, the reuse rate of the profile is low in the later stage, The use of t-nuts is low cost and easy to disassemble and assemble, the choice of non-removable square nuts will cause the problem of not being easy to disassemble and assemble, choose stainless steel spring nuts with higher costs, there is no practical way. To ensure the rigidity of the frame is to add glue to the gasket (special washer instead of the screw itself, High-strength screws are chosen to ensure removability.
