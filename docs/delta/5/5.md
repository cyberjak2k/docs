...
2. Apply thread-locking adhesive to the M3*10 cap-head screws. i]Insert them into the metal mounting bracket, and tighten using two self-locking nuts.
...
2.C onnect the two spoon-shaped rods using two tension springs, as shown in the figure.
