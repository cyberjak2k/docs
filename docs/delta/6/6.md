...
2.Use two M3*14 cup-head screws to pass through the heated bed mount and screw on two drop-in t-nuts, type 20-M3, do not tighten them completely, just tighten them, as shown in the picture.
...
1.Use two M3*8 countersunk screws to pass through the heated bed baffle, and screw on two type 20 - M3 drop-in t-nuts, do not tighten them completely, just tighten them, as shown in the picture .
...
1.Pass two M3*8 countersunk screws through the rear heated bed baffle and screw on two drop-in type20 - M3 boat nuts, do not tighten them completely, just tighten them as shown in the picture.
