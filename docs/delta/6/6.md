...
7.Fine-tune the position of the heated bed aluminum plate and the heated bed support so that all three holes in the heated bed aluminum plate can fit into the threaded steel ball heads of the heated bed support. 

!!! warning "warning"
     After ensuring that all three holes in the heated bed aluminum plate can fit into the blind ball heads on the heated bed support.

     measure and fine-tune the distance between the edge of the short aluminum profile and the two sides of the heated bed support to make them basically consistent. 

     Then, tighten all the M3*14 cap head screws on the heated bed support securing the profiles.
...
!!! info "Embedded nut" 
    After tightening, check the heated bed aluminum plate to ensure that the heated bed aluminum plate and the threaded steel ball head of the heated bed support are tightly fitted without gaps, and that there will be no shaking or unevenness. If there is any, loosen the screw and readjust.
